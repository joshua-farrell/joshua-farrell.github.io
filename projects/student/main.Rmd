...
three categories in each categorical variable.
...
See the "test" `roc`, for Random Forest:
...
THe random forest model provided a considerably better fit in the prediction of student satisfaction.
...
may give insight into recruting and intrusive advising practices,e.g. targeting 
interventions at freshman groups less likely to be satisfied. As the sample size and 
data quality improve it seems likely models can be improved by adding variation accross time.     
